        ...
        <div className="section_design">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <h6 className="watch_recommendations">Get more recommendations <FontAwesomeIcon icon={faChevronRight} /></h6>
                    </div>
                </div>

                <div className="row side_design">
                    <h2 className="second_title">Top picks <FontAwesomeIcon icon={faChevronRight} className="right_arrow" /></h2>
                    <p className="subtitle">TV shows and movies just for you</p>
                    <Link to="/" className="watch_sign_in">Sign In</Link>
                </div>
            </div>
